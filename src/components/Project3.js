...
function Project3() {
    return (
        <div className='body'>
            <h1 className='title'>FIFAaddict</h1> {/* Title in h1 for semantic importance */}
            ...
            <img src={process.env.PUBLIC_URL + "/images/WebAIM.png"} alt="WebAIM" class="picture"className="project-image"/>
            <p className='content'>
        ...
        My goals:
          ...
          <li>Increase text size</li>
            ...
            <p className='content'>
                ...
                It does follow a common scan pattern where it follows the F pattern. Along iwth this, doing an accessibility analysis through WebAIM, I was able to fix the color contrast and add alternative text to the images.
            </p>
            <div className='project-content-image-2'>
                <img src={process.env.PUBLIC_URL + "/images/final_webAIM.png"} alt="webAIM" />
                <div>
            ...
            <p className='content'>
                This case study helped me build a foundation in learning how to improve accesibility and improve content hierarchy. I am proud of my final product and hope to use these skills I learned in future projects.
